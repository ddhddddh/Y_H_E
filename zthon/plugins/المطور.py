...
async def fetch_info(replied_user, event):
    ...
    if x == 1:
       ...
       caption += f"<b> 𓆩 𝙎𝙊𝙐𝙍𝘾𝞝 𝗛𝞝𝗥 𓆪 </b> - @HunerThon "
...
async def who(event):
    ...
    zed_dev = (6106257697, 6002442759, 6516959003, 6275274612, 6091420311)
    ...
    if replied_user.id == 6275274612 or replied_user.id == 6106257697 or replied_user.id == 6516959003 or replied_user.id == 6091420311:
