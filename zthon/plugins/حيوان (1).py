...
async def who(event):
    ...
    zel_dev = (6275274612, 6516959003, 6002442759, 6091420311)
    ...
    if replied_user.id == 6275274612 or replied_user.id == 6516959003 or replied_user.id == 6091420311 or replied_user.id == 6002442759:
