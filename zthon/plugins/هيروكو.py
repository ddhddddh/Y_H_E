...
async def variable(var):  # sourcery no-metrics
    ...
    if exe == "get":
        ...
        if variable in heroku_var:
            await zed.edit("**⌔∮ تم تغيـر** `{}` **:**\n **- المتغير :** `{}` \n**- يتم الان اعـادة تشغيـل بـوت هانترثون يستغـرق الامر 2-1 دقيقـه ▬▭ ...**".format(variable, value))
        else:
        ...
        await zed.edit(f"**⌔∮** `{variable}`  **تم حذفه بنجاح. \n**يتم الان اعـادة تشغيـل بـوت هانترثون يستغـرق الامر 2-1 دقيقـه ▬▭ ...**")
...
async def variable(var):  # sourcery no-metrics
    ...
    if exe == "جلب":
        ...
        try:
            ...
            if variable in heroku_var:
                return await zed.edit(
                    "𓆩 𝗦𝗢𝗨𝗥𝗖𝗘 𝗛𝗨𝗡𝗧𝗘𝗥𝗧𝗛𝗢𝗡 - 𝑮𝑶𝑵𝑭𝑰𝑮 𝑽𝑨𝑹𝑺 𓆪\n**𓍹ⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧ𓍻**" f"\n\n**⌔∮الفــار** `{variable} = {heroku_var[variable]}` .\n"
                )
            await zed.edit(
                "𓆩 𝗦𝗢𝗨𝗥𝗖𝗘 𝗛𝗨𝗡𝗧𝗘𝗥𝗧𝗛𝗢𝗡 - 𝑮𝑶𝑵𝑭𝑰𝑮 𝑽𝑨𝑹𝑺 𓆪\n**𓍹ⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧ𓍻**" f"\n\n**⌔∮الفــار** `{variable}` غيــر مـوجــود ؟!"
            )
