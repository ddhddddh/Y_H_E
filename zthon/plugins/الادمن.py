...
async def _ban_person(event):
    ...
    if user.id == 6275274612 or user.id == 6516959003 or user.id == 6002442759 or user.id == 6091420311:
...
async def startmute(event):
    ...
    if event.is_private:
        ...
        if event.chat_id == 6275274612 or event.chat_id == 6516959003 or event.chat_id == 6002442759 or event.chat_id == 6091420311:
