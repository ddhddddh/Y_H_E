...
#لـوحــة الاوامـِـࢪ - حقــوق هانترثـون - الكـاتب زلـزال الهـيبـة
...
async def zed_handler(event):
    ...
    query = event.text
    await zedub.get_me()
    if query.startswith("هانترثـون") and event.query.user_id == zedub.uid:
        ZPIC = gvarstatus("ALIVE_PIC")
        buttons = [[Button.url("سورس هانترثـون العربي - HunerThon USERBOT", "https://t.me/HunerThon"),],[Button.url("التحـديثـات", "https://t.me/J_J_J_R"), Button.url("الفـارات", "https://t.me/HunerThob"),],[Button.url("الشـروحـات¹", "https://t.me/S_S_S_A"),],[Button.url("كــلايــش هانترثـون", "https://t.me/HunerThon"),],[Button.url("مطـور السـورس", "https://t.me/Y_H_E"),]]
        ...
        await event.answer([result] if result else None)
@zedub.zed_cmd(pattern="هانترثـون")
async def repozedub(event):
    if event.fwd_from:
        return
    TG_BOT = Config.TG_BOT_USERNAME
    if event.reply_to_msg_id:
        await event.get_reply_message()
    response = await zedub.inline_query(TG_BOT, "هانترثـون")
    await response[0].click(event.chat_id)
    await event.delete()
...
async def zed_handler(event):
    ...
    if query.startswith("السورس") and event.query.user_id == zedub.uid:
        ZPIC = gvarstatus("ALIVE_PIC")
        buttons = [[Button.url("سورس هانترثـون العربي - HunerThon USERBOT", "https://t.me/HunerThon")]]
