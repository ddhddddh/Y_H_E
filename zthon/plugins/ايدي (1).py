...
zed_TEXT = gvarstatus("CUSTOM_ALIVE_TEXT") or "•⎚• مـعلومـات المسـتخـدم مـن بـوت هانترثون"
zedM = gvarstatus("CUSTOM_ALIVE_EMOJI") or "✦ "
zedF = gvarstatus("CUSTOM_ALIVE_FONT") or "⋆─┄─┄─┄─ 𝗛𝗨𝗡𝗧𝗘𝗥𝗧𝗛𝗢𝗡 ─┄─┄─┄─⋆"
zed_dev = (6275274612, 6002442759, 6516959003, 6091420311)
zed_dev = (6275274612, 6002442759, 6516959003, 6091420311)
alsarot = (6275274612, 6002442759, 6516959003, 6091420311)
...
async def fetch_info(replied_user, event):
    ...
    zedot = (await event.client.get_entity(user_id)).premium
    ...
    if user_id in zedot: # code by https://t.me/Y_H_E
    ...
    if zedot == True or user_id in zedot: # code by https://t.me/Y_H_E
