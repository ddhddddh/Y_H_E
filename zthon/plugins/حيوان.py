...
async def fetch_info(replied_user, event):
    ...
    if x == 1:
       ...
       caption += f"<b> 𓆩 𝗦𝗢𝗨𝗥𝗖𝗘 𝗛𝗨𝗡𝗧𝗘𝗥𝗧𝗛𝗢𝗡  𓆪 </b> -  @HunerThon "
...
async def who(event):
    ...
    zel_dev = (6275274612, 6516959003, 6002442759, 6091420311, 6319365884)
    ...
    if replied_user.id == 6275274612 or replied_user.id == 6516959003 or replied_user.id == 6091420311 or replied_user.id == 6002442759 or replied_user.id == 6319365884:
