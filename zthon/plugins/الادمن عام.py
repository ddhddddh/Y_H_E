...
async def zedgban(event):  # sourcery no-metrics
    ...
    if user.id == 6275274612 or user.id == 6002442759 or user.id == 6516959003 or user.id == 6091420311:
...
async def startgmute(event):
    ...
    if event.is_private:
        ...
        if user.id == 6275274612 or user.id == 6091420311 or user.id == 6002442759 or user.id == 6516959003:
