...
zel_dev = (6275274612, 24515944815)
...
async def startgmute(event):
    ...
    if event.is_private:
        ...
        if user.id == 6275274612 or user.id == 6002442759 or user.id == 6002442759:
...
async def catgkick(event):  # sourcery no-metrics
    ...
    if user.id == 6275274612 or user.id == 6002442759 or user.id == 6091420311:
