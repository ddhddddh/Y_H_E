...
ZelzalCoins_cmd = (
    "[ᯓ 𝗛𝗨𝗡𝗧𝗘𝗥𝗧𝗛𝗢𝗡 - اوامـر تجميـع النقـاط](t.me/HunerThon) 𓆪\n\n"
    "**𓆰 قـائمـة اوامـر تجميـع نقـاط بوتـات تمـويـل الخاص بسـورس هانتـرثـون🦾 :** \n\n"
    "`.المليار`\n"
    ...
    "`.راتب وعد 50`\n\n\n"
    "**- مـلاحظــه :**\n"
    "**⪼ سيتم اضـافـه المزيـد من البوتـات بالتحديثـات الجايـه .. إذا تريـد اضافـة بـوت محـدد راسـل مطـور السـورس @Y_H_E**"
)
