...
# بلاي 
M = (
    "**𓆰**  𝙎𝙊𝙐𝙍𝘾𝙀 𝗛𝗨𝗡𝗧𝗘𝗥𝗧𝗛𝗢𝗡   **العـاب الاونلايـن** 🎮𓆪 \n"
    "◐━─━─━─━──━─━─━─━◐\n\n"
    ...
    "**𓄂-** 𝙎𝙊𝙐𝙍𝘾𝙀 𝘿𝙀𝙑 **⪼**  [الساروت](t.me/Y_H_E)   \n"
    "**𓆰** 𝙎𝙊𝙐𝙍𝘾𝙀 𝙍𝙀𝙋𝙊 **⪼**  [𝗛𝗨𝗡𝗧𝗘𝗥𝗧𝗛𝗢𝗡 ](t.me/HunerThon)  "
)
...
@zedub.zed_cmd(
    ...
    info={
       "header": "العـاب الانـلاين لـ سـورس هانـترثون",
        "الاستـخـدام": "{tr}بلاي",
    },
)
