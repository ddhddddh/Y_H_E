    ...
    try:
        ...
        if BOTLOG:
            ...
            Config.ZEDUBLOGO = await zedub.tgbot.send_file(
                ...
                buttons=[(Button.url("𝗛𝗨𝗡𝗧𝗘𝗥𝗧𝗛𝗢𝗡", "https://t.me/HunerThon"),)],
...
async def mybot():
    ...
    if bot_name.endswith("Assistant"):
        ...
        try:
            ...
            await bot.send_message("@BotFather", f"- بـوت هانترثـون المسـاعـد ♥️🦾 الخـاص بـ  {bot.me.first_name} ")
...
zthon = {"@HunerThon", "@S_s_S_a", "@J_J_J_R", "@N_5_5_5", "@OoO15", "@JO6JJ"}
async def saves():
...
async def verifyLoggerGroup():
    ...
    if BOTLOG:
            ...
            if not isinstance(entity, types.User) and not entity.creator:
                ...
                if entity.default_banned_rights.send_messages:
                    ...
                    LOGS.info(
                        ...
                        "- الصلاحيات غير كافيه لإرسـال الرسائـل في مجموعه فار ااـ PRIVATE_GROUP_BOT_API_ID."
        ...
        photozed = await zedub.upload_file(file="zedthon/malath/Huner.jpg")

        _, groupid = await create_supergroup(

            "كـروب السجـل هانترثـون", zedub, Config.TG_BOT_USERNAME, descript, photozed
            ...
            if not isinstance(entity, types.User) and not entity.creator:
                ...
                if entity.default_banned_rights.send_messages:
                    ...
                    LOGS.info(
                        ...
                        " الصلاحيات غير كافيه لإرسـال الرسائـل في مجموعه فار ااـ PM_LOGGER_GROUP_ID."
